...
def generate_panchang_article(astro_data):
    ...
    7. AI Image Prompt: A 20-30 word visual scene description for FLUX.1 depicting an ancient Sanskrit astrological palm-leaf manuscript with an antique brass astronomical sundial and star chart, open on a carved wooden table with glowing brass oil diya lamps, with a clear starry night sky and glowing crescent moon in the background. CRITICAL: NEVER describe a human or deity statue/idol for Panchang. Focus on astronomical manuscripts and celestial night sky. Do NOT include text.
